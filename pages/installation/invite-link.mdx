...
These permissions are connected to specific actions that your bot does, if you want to do a specific action (like banning a member) and it does not have the permission, it will return an error.